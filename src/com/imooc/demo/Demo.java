...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        Employee employee1 = new Employee("张铭", "S001", 29, "男", department1, duty3);
        Employee employee2 = new Employee("李艾爱", "S002", 21, "女", department1, duty2);
        Employee employee3 = new Employee("孙超", "S004", 29, "男", department1, duty1);
        Employee employee4 = new Employee("孙美美", "S005", 26, "女", department3, duty1);
        Employee employee5 = new Employee("蓝迪", "S006", 37, "男", department3, duty3);
        Employee employee6 = new Employee("米莉", "S007", 24, "女", department3, duty1);
        ...
        System.out.println(employee5.employeeInfo());
        System.out.println(employee6.employeeInfo());
